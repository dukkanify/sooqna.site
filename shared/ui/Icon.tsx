...
const paths: Partial<Record<IconName, string>> = {
  ...
  /** Stacked coins — price / السعر (optically centered in 24×24) */
  coins:
    "M7 7.5c0 1.38 2.24 2.5 5 2.5s5-1.12 5-2.5S14.76 5 12 5 7 6.12 7 7.5Zm0 0v3c0 1.38 2.24 2.5 5 2.5s5-1.12 5-2.5v-3M7 10.5v3c0 1.38 2.24 2.5 5 2.5s5-1.12 5-2.5v-3M7 13.5v3c0 1.38 2.24 2.5 5 2.5s5-1.12 5-2.5v-3",
