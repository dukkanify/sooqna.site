...
const FILLED: Record<GlyphName, string> = {
  // Front-facing car — matches the premium circular set
  car: "M7.2 13.6 8.6 9.8A1.5 1.5 0 0 1 10 8.8h4a1.5 1.5 0 0 1 1.4 1l1.4 3.8H18.4v1.7h-1.1a2 2 0 0 1-3.9 0H10.6a2 2 0 0 1-3.9 0H5.6v-1.7h1.6Zm1.8-2.6.5-1.4h5l.5 1.4H9ZM8.6 15.8a1 1 0 1 0 0-2 1 1 0 0 0 0 2Zm6.8 0a1 1 0 1 0 0-2 1 1 0 0 0 0 2Z",
  ...
  sofa: "M8 9.6V7.8A1.8 1.8 0 0 1 9.8 6h4.4A1.8 1.8 0 0 1 16 7.8v1.8h1.6A1.5 1.5 0 0 1 19.1 11.1v3.5A1.5 1.5 0 0 1 17.6 16.1H6.4A1.5 1.5 0 0 1 4.9 14.6v-3.5A1.5 1.5 0 0 1 6.4 9.6H8Z",
  briefcase:
