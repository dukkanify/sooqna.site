...
const FILLED: Record<GlyphName, string> = {
  ...
  watch:
    "M9 2h6v3.2H9V2Zm0 16.8h6V22H9v-3.2ZM12 6a6 6 0 1 1 0 12 6 6 0 0 1 0-12Zm0 2.4a3.6 3.6 0 1 0 0 7.2 3.6 3.6 0 0 0 0-7.2Zm.35 1.2v2.35l1.75 1-.55.95-2.2-1.25V9.6h1Z",
  paw: "M7.8 8.8a2.35 2.35 0 1 0 0-4.7 2.35 2.35 0 0 0 0 4.7Zm8.4 0a2.35 2.35 0 1 0 0-4.7 2.35 2.35 0 0 0 0 4.7ZM5 13.6a2.35 2.35 0 1 0 0-4.7 2.35 2.35 0 0 0 0 4.7Zm14 0a2.35 2.35 0 1 0 0-4.7 2.35 2.35 0 0 0 0 4.7ZM12 21c3.7 0 6.5-2.5 6.5-5.6S15.7 11 12 11s-6.5 1.9-6.5 4.4S8.3 21 12 21Z",
  wrench:
